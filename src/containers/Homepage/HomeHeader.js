        ...
        <div className="home-header-container container">
          <div className="home-header-content">
            ...
            <div className="right-content">
              ...
              <div
                className={
                  language === LANGUAGES.VI ? "lag-vi active" : "lag-vi"
                }
              >
                <span onClick={() => this.handleChangeLangue(LANGUAGES.VI)}>
                  VN
                </span>
              </div>
              <div
              ...
              >
                <span onClick={() => this.handleChangeLangue(LANGUAGES.EN)}>
                  EN
                </span>
              </div>
            </div>
